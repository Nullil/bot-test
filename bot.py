...
#main variables
TOKEN = "675191031:AAF78SHILQ4hoqSnnrWuL_3fF3Q-NAvvxQI"
...
#         output = parser1.getTitlesFromTop(int(text), task.myFilter)
#     else:
#         output = parser1.getTitlesFromAll(int(text), task.myFilter)
